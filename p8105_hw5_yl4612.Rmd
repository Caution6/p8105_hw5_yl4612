...
According to the spaghetti plot, experimental group has a general trend of increment, while control group does not. In week eight, all observations of experimental group are higher than those of control group.
...
Make a second plot the average estimate of mu only in samples for which the null was rejected on the y axis and the true value of mu on the x axis.
